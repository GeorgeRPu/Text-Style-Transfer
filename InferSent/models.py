...
class InferSent(nn.Module):
    ...
    # HACK: skip sorting stuff in forward
    def embed(self, sent_len, sent_tensor):
        '''
        args:
            sent_len: list of sentence length
            sent_tensor: stacked word vectors for sentence
        returns:
            emb: sentence vector
        '''
        sent_packed = nn.utils.rnn.pack_padded_sequence(sent_tensor, sent_len)
    ...
    def build_vocab_k_words(self, K):
        ...
        # HACK: return word_vec, since it's not showing as an instance var
